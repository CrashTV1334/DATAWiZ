...
function myFunction(arr) {
    ...
    for (var i = 1; i < facilityArr.length; i++) {
        facilitySel1.options[facilitySel1.options.length] = new Option(facilityArr[i]["Facility Name"], facilityArr[i]["Facility Name"]);
        facilityMap1.set(facilityArr[i]["Facility Name"], i);
    }
    for (var i = 1; i < facilityArr.length; i++) {
        facilitySel2.options[facilitySel2.options.length] = new Option(facilityArr[i]["Facility Name"], facilityArr[i]["Facility Name"]);
        facilityMap2.set(facilityArr[i]["Facility Name"], i);
    }
